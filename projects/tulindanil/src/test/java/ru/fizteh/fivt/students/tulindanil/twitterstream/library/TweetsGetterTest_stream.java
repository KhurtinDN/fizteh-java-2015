...
public class TweetsGetterTest_stream {
    private ru.fizteh.fivt.students.tulindanil.twitterstream.library.Location MoscowLocation = new ru.fizteh.fivt.students.tulindanil.twitterstream.library.Location(55.7500, 37.6167, "Moscow");
                ...
                .then(invocation -> {
                    switch (invocation.getArguments()[0].toString()) {
                        ...
                        case "Russia, Moscow":
                            return MoscowLocation;
                        case "Пермь":
                            return new ru.fizteh.fivt.students.tulindanil.twitterstream.library.Location(58.0000, 56.3167, "Пермь");
                        case "Омск":
                            return new ru.fizteh.fivt.students.tulindanil.twitterstream.library.Location(54.9833, 73.3667, "Омск");
                        case "Красноярск":
                            return new ru.fizteh.fivt.students.tulindanil.twitterstream.library.Location(56.0167, 93.0667, "Красноярск");
                        default:
    ...
    public void testGetTwitterStream() throws Exception {
        ...
        tweetsGetter.launchTwitterStream(setUpJCommanderSettings("-q", "а", "-p",
