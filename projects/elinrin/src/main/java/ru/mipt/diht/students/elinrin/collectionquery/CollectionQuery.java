...
public class CollectionQuery {
    ...
    public static class Student {
        ...
        public Student(final String name, final LocalDate dateOfBith, final String group) {
            this.name = name;
            this.dateOfBith = dateOfBith;
            this.group = group;
        }

        public Student(final String name, final String group) {
            this.name = name;
            this.dateOfBith = null;
            this.group = group;
        }
    ...
    public static class Group {
        ...
        public Group(final String group, final String mentor) {
            this.group = group;
            this.mentor = mentor;
        }
    ...
    public static class Statistics {
        ...
        public Statistics(final String group, final Integer count) {
            this.group = group;
            this.count = count;
            this.age = null;
        }

        public Statistics(final String group, final Integer count, final Double age) {
            this.group = group;
            this.count = count;
            this.age = age;
        }

        public Statistics(final String group) {
            this.group = group;
            this.count = null;
            this.age = null;
        }
