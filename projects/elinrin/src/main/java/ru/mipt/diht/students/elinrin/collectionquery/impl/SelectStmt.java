...
public class SelectStmt<T, R> {
    ...
    @SafeVarargs
    public SelectStmt(final List<T> elements, final Class<R> returnClass, final boolean isDistinct,
    ...
    @SafeVarargs
    public SelectStmt(final List<R> pastElements, final List<T> elements, final Class<R> returnClass,
                      final boolean isDistinct, final Function<T, ?>... functions) {
        this.elements = new ArrayList<>();
        for (T element : elements) {
            this.elements.add(element);
        }
    ...
    public SelectStmt(final List<R> pastElements, final List<T> elements, final boolean isDistinct,
    ...
    @SafeVarargs
    public final SelectStmt<T, R> orderBy(final Comparator<R>... comparators) {
